...
import panelIcon from '../../assets/WorkerDashboard/panel.png'
...
import cursosIcon from '../../assets/WorkerDashboard/cursos.png'
import progresoIcon from '../../assets/WorkerDashboard/progreso.png'
import perfilIcon from '../../assets/WorkerDashboard/perfil.png'
import configuracionIcon from '../../assets/WorkerDashboard/configuracion.png'
import soporteIcon from '../../assets/WorkerDashboard/soporte.png'
import SidebarSupportCard from '../layout/SidebarSupportCard'

const iconMap = {
  panel: { src: panelIcon },
  applications: { src: postulacionesIcon },
  microjobs: { src: trabajosIcon },
  availableCourses: { src: cursosIcon },
  coursesInProgress: { src: progresoIcon },
  profileStatus: { src: perfilIcon, size: 'h-[23px] w-[23px]' },
  configuration: { src: configuracionIcon, size: 'h-[23px] w-[23px]' },
}
      ...
      >
        ...
        <div className="dashboard-sidebar-content mt-5 flex flex-1 flex-col justify-between">
          <nav
            ...
            aria-label="Navegación del trabajador"
          >
