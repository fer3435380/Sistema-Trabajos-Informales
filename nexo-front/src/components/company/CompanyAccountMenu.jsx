function CompanyAccountMenu({
  ...
  const menuItems = [
    { id: 'status', label: 'Ver estado de la empresa', onClick: onViewCompanyStatus },
    { id: 'edit', label: 'Editar información', onClick: onEditProfile },
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-[var(--color-primary-strong)]">
              {profile.commercialName || profile.companyName}
            </p>
